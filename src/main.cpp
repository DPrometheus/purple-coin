...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // PurpleCoin: 1 days
static const int64 nTargetSpacing = 120; // PurpleCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal purplecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PurpleCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x44fdc462ff21aba95265589a5e24d4734b054dbc3bc73ae806e7e83bccf0bbeb");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "29 -10 -2013 00:00:00 (GMT+1)";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1383001200; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1383001200;
            block.nNonce   = 339102;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbad95db8a343d20f967948db75102150e5661cad4f93cee3a124fbcd3b9b0606"));
